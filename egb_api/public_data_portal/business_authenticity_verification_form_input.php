...
$bNo = egb('b_no', 'publicDataPortal1');
...
// CURL 오류 확인
if (curl_errno($ch)) {
    echo json_encode(['success' => false, 'failureCode' => 'publicDataPortal2', 'error' => curl_error($ch)]);
    curl_close($ch);
    exit;
}
