    ...
    <div class="flex_fl width_box height_box padding_px-l_200" data-xy="1-1200: flex_ft padding_px-l_000">
        ...
        <div class="width_box height_box padding_px-a_020" data-bg-color="#E6E6E5">
            <div class="flex_xs1_yc padding_px-u_020"
                ...
                <div class="font_px_020 flv6">회원로그인기록</div>
                <div class="flex_xc" data-xy="1-800: flex_xr, 801-1200: flex_xc">
                    <div class="flex_xs1_yc width_px_300 font_px_016 padding_px-u_000" data-color="#888888"
                        ...
                        <div>회원관리</div>
                        <div>></div>
                        <div class="flv6" data-color="#000000">회원로그인기록</div>
                    </div>
                </div>
            </div>
            <div class="flex_ft width_box border_px-a_002 font_px_016" data-bd-a-color="#d9d9d9"
                    ...
                    <div class="flex_fl_yc height_px_055 border_px-u_001 padding_px-x_010 padding_px-y_010 width_box height_box"
                        ...
                        <div class="flex_fl_yc min_width_375 width_px_375 padding_px-u_000"
                            ...
                            <input class="width_px_018 height_px_018 border_px-a_001" data-bd-a-color="#888888"
                                type="radio" name="crm_member_management_connection_time"
                                id="crm_member_management_connection_time_all"
                                data-xy="1-800: width_px_016 height_px_016"  checked>
                            <label class="padding_px-l_005 padding_px-r_020"
                                for="crm_member_management_connection_time_all"
                                data-xy="1-800: padding_px-r_010">전체</label>
                            <input class="width_px_018 height_px_018 border_px-a_001" data-bd-a-color="#888888"
                                type="radio" name="crm_member_management_connection_time"
                                id="crm_member_management_connection_time_today"
                                data-xy="1-800: width_px_016 height_px_016">
                            <label class="padding_px-l_005 padding_px-r_020"
                                for="crm_member_management_connection_time_today"
                                data-xy="1-800: padding_px-r_010">오늘</label>
                            <input class="width_px_018 height_px_018 border_px-a_001" data-bd-a-color="#888888"
                                type="radio" name="crm_member_management_connection_time"
                                id="crm_member_management_connection_time_3day"
                                data-xy="1-800: width_px_016 height_px_016">
                            <label class="padding_px-l_005 padding_px-r_020"
                                for="crm_member_management_connection_time_3day"
                                data-xy="1-800: padding_px-r_010">3일</label>
                            <input class="width_px_018 height_px_018 border_px-a_001" data-bd-a-color="#888888"
                                type="radio" name="crm_member_management_connection_time"
                                id="crm_member_management_connection_time_7day"
                                data-xy="1-800: width_px_016 height_px_016">
                            <label class="padding_px-l_005 padding_px-r_020"
                                for="crm_member_management_connection_time_7day"
                                data-xy="1-800: padding_px-r_010">7일</label>
                            <input class="width_px_018 height_px_018 border_px-a_001" data-bd-a-color="#888888"
                                type="radio" name="crm_member_management_connection_time"
                                id="crm_member_management_connection_time_period_search"
                                data-xy="1-800: width_px_016 height_px_016">
                            <label class="padding_px-l_005 padding_px-r_020"
                                for="crm_member_management_connection_time_period_search"
                        ...
                        <div class="flex_fl_yc width_box height_box" data-bg-color="#ffffff" data-xy="1-1200: flex_ft">
                            <div class="flex_fl_yc" data-xy="1-1200: width_box">
                                <div class="flex_fl_yc" data-xy="1-800: width_box">
                                    <select id="crm_member_management_year_four_1" name=""
                                        class="width_px_080 padding_px-y_008 padding_px-x_005 font_px_014 border_px-a_001 crm_member_management_year_four_1"
                                ...
                                <div class="flex_fl_yc" data-xy="1-800: width_box">
                                    <select id="crm_member_management_month_four_1" name=""
                                        class="width_px_080 padding_px-y_008 padding_px-x_005 font_px_014 border_px-a_001 crm_member_management_month_four_1"
                                ...
                                <div class="flex_fl_yc" data-xy="1-800: width_box">
                                    <select id="crm_member_management_day_four_1" name=""
                                        class="width_px_080 padding_px-y_008 padding_px-x_005 font_px_014 border_px-a_001 crm_member_management_day_four_1"
                            ...
                            <div class="flex_fl_yc" data-xy="1-1200: width_box">
                                <div class="flex_fl_yc" data-xy="1-800: width_box">
                                    <select id="crm_member_management_year_four_2" name=""
                                        class="width_px_080 padding_px-y_008 padding_px-x_005 font_px_014 border_px-a_001 crm_member_management_year_four_2"
                                        data-bd-a-color="#888888" data-xy="1-800: width_box font_px_012 min_width_065">
                                        <option value="선택" selected hidden disabled>선택</option>
                                    </select>
                                    <div class="padding_px-l_005 padding_px-r_015"
                                ...
                                <div class="flex_fl_yc" data-xy="1-800: width_box">
                                    <select id="crm_member_management_month_four_2" name=""
                                        class="width_px_080 padding_px-y_008 padding_px-x_005 font_px_014 border_px-a_001 crm_member_management_month_four_2"
                                        data-bd-a-color="#888888" data-xy="1-800: width_box font_px_012 min_width_060">
                                        <option value="선택" selected hidden disabled>선택</option>
                                        <option value="1">1</option>
                                        <option value="2">2</option>
                                ...
                                <div class="flex_fl_yc" data-xy="1-800: width_box">
                                    <select id="crm_member_management_day_four_2" name=""
                                        class="width_px_080 padding_px-y_008 padding_px-x_005 font_px_014 border_px-a_001 crm_member_management_day_four_2"
                                        data-bd-a-color="#888888" data-xy="1-800: width_box font_px_012">
                                        <option value="선택" selected hidden disabled>선택</option>
                                    </select>
                                    <div class="padding_px-l_005">일</div>
                ...
                <script nonce="<?php echo NONCE; ?>">
                    document.addEventListener('DOMContentLoaded', function () {
                        ...
                        // 라디오 버튼과 기간 선택 요소
                        const radioButtons = document.querySelectorAll('input[name="crm_member_management_connection_time"]');
                        const yearSelects = [
                            document.getElementById('crm_member_management_year_four_1'),
                            document.getElementById('crm_member_management_year_four_2'),
                        ];
                        const monthSelects = [
                            document.getElementById('crm_member_management_month_four_1'),
                            document.getElementById('crm_member_management_month_four_2'),
                        ];
                        const daySelects = [
                            document.getElementById('crm_member_management_day_four_1'),
                            document.getElementById('crm_member_management_day_four_2'),
                        ];
                        ...
                        radioButtons.forEach(radio => {
                            radio.addEventListener('change', function () {
                                ...
                                if (value === 'crm_member_management_connection_time_today') {
                                    setDate(date1, date2, yearSelects, monthSelects, daySelects);
                                } else if (value === 'crm_member_management_connection_time_3day') {
                                    date1.setDate(today.getDate() - 3); // 첫 번째 그룹은 3일 전
                                    setDate(date1, date2, yearSelects, monthSelects, daySelects);
                                } else if (value === 'crm_member_management_connection_time_7day') {
...
<script nonce="<?php echo NONCE; ?>">
    ...
    for (let i = 1; i <= groupCount; i++) {
        dateGroups.push({
            year: document.querySelector(`.crm_member_management_year_four_${i}`),
            month: document.querySelector(`.crm_member_management_month_four_${i}`),
            day: document.querySelector(`.crm_member_management_day_four_${i}`)
        });
    }
