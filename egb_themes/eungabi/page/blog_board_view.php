...
if (isset($user_login)) {
    ...
    echo "<script nonce=" . NONCE . " type='text/javascript'>window.location.href='" . DOMAIN . '/page/blog_board_preview/?uniq_id=' . $uniq_id . "'; </script>";
    exit;
}
...
if (!isset($sql_post[0]['uniq_id'])) {
    echo "<script nonce=" . NONCE . " type='text/javascript'>window.location.href='" . DOMAIN . '/page/blog_board_list' . "'; </script>";
    exit;
}
...
";
$params_user = [
    ':user_uniq_id' => $board_user_uniq_id
];
    ...
    <div class="padding_px-x_010">
        <div class="width_px_720 margin_x_auto padding_px-y_050" data-xy="1-800: width_box">
            <div class="flex_ft font_px_015 manual_content_1">
                <div class="blog_title_1 font_px_025 flv6 padding_px-u_010"><?php echo $post_data[0]['title']; ?></div>
            </div>
            <div class="width_box height_auto padding_px-u_020">
                <img src="<?php echo DOMAIN . $post_data[0]['image']; ?>"
                    class="blog_main_img width_box height_box" style="object-fit: cover;">
            </div>
			<div class="flex_ft font_px_015 blog_content_1">
				<div class="blog_contents_1"><?php echo nl2br($post_data[0]['content']); ?></div>
			</div>
            <script nonce="<?php echo NONCE; ?>">
                // Select all thumbnail images
                var thumbnails = document.querySelectorAll('[class*="blog_img_"]');
                // Select the main image
                var mainImage = document.querySelector('.blog_main_img');
                // Select all content divs
                var contentDivs = document.querySelectorAll('[class*="blog_content_"]');
                ...
                thumbnails.forEach(function (thumbnail) {
                    thumbnail.addEventListener('click', function () {
                        ...
                        var indexClass = classes.find(function (cls) {
                            return cls.startsWith('blog_img_');
                        });
                        ...
                        contentDivs.forEach(function (contentDiv) {
                            ...
                            var contentIndexClass = contentClasses.find(function (cls) {
                                return cls.startsWith('blog_content_');
                            });
          ...
          FROM egb_like_log 
          WHERE like_target_table = 'egb_board_blog'
          ...
          FROM egb_scrap_log 
          WHERE scrap_target_table = 'egb_board_blog'
          AND scrap_target_uniq_id = :post_uniq_id";
            ...
            <div class="flex_fl_yc_wrap padding_px-y_030 font_px_013" data-color="#828c94">
                ...
                <span>좋아요&nbsp;<span class="blog_side_heart_count"><?php echo number_format($like_count); ?></span></span>
                <span class="padding_px-x_003">·</span>
                <span>스크랩&nbsp;<span class="blog_side_scrap_count"><?php echo number_format($scrap_count); ?></span></span>
                <span class="padding_px-x_003">·</span>
                <span>조회&nbsp<span class="blog_view_total_count"><?php echo number_format($view_total_count); ?></span></span>
            </div>
...
";
                ...
                if (isset($sql_post[0]) && !empty($sql_post[0])) {
                    ...
                    for ($i = 0; $i < min(3, $post_count); $i++) {
                        ...
                        if (!empty($posts_data) && isset($posts_data[0])) {
                            ...
                            <a class="padding_px-a_010"
                                href="<?php echo DOMAIN . '/page/blog_board_view/?uniq_id=' . $post['uniq_id']; ?>">
                    ...
                    if ($post_count > 3) {
                        ?>
                        <a class="padding_px-a_010" href="<?php echo DOMAIN . '/page/blog_board_plus_view'; ?>">
                            <div class="position1 height_px_180 width_box border_bre-a_005 overflow_hidden pointer a"
                                data-xy="1-500: height_px_150, 501-800: height_px_200">
                                <img class="pointer width_box height_box a_1" src="<?php echo DOMAIN . $image; ?>"
                                    style="object-fit: cover;">
...
<?php
auto_comment('egb_comment_blog', $uniq_id, $board_user_uniq_id); 
auto_floating('egb_board_blog', $uniq_id, 'blog');

 //조회수 1증가
 $query = "UPDATE egb_board_blog SET board_view = board_view + 1 WHERE uniq_id = :uniq_id";
