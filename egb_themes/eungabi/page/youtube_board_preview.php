...
if (isset($user_login)) {
    ...
    echo "<script nonce=" . NONCE . " type='text/javascript'>window.location.href='" . DOMAIN . '/page/youtube_board_view/?uniq_id=' . $uniq_id . "'; </script>";
    exit;
}
        ...
        <div class="width_px_720 margin_x_auto padding_px-y_050" data-xy="1-800: width_box">
            <div class="position1">
                <div class="width_box height_px_1000">
                    <img src="<?php echo DOMAIN . $post_data['thumbnail']; ?>"
...
";
                ...
                if (isset($sql_post[0]) && !empty($sql_post[0])) {
                    ...
                    for ($i = 0; $i < min(3, $post_count); $i++) {
                        ...
                        if (!empty($posts_data) && isset($posts_data[0])) {
                            ...
                            <a class="padding_px-a_010"
                                href="<?php echo DOMAIN . '/page/youtube_board_preview/?uniq_id=' . $post['auto_youtube_board_uniq_id']; ?>">
                    ...
                    if ($post_count > 3) {
                        ?>
                        <a class="padding_px-a_010" href="<?php echo DOMAIN . '/page/youtube_board_plus_view'; ?>">
                            <div class="position1 height_px_180 width_box border_bre-a_005 overflow_hidden pointer a"
                                data-xy="1-500: height_px_150, 501-800: height_px_200">
                                <img class="pointer width_box height_box a_1" src="<?php echo DOMAIN . $image; ?>"
                                    style="object-fit: cover;">
...
//댓글 출력
//프로팅 출력
 auto_comment('egb_comment_youtube', $uniq_id, $user_uniq_id); 
