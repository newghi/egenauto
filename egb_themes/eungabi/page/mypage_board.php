...
if ($user_uniq_id) {
    ...
    $query = "SELECT log_target_table, log_board_uniq_id FROM egb_board_log WHERE log_user_uniq_id = :user_id AND is_status = 1 ORDER BY created_at DESC LIMIT 10";
                ...
                <div class="width_px_820 margin_px-u_080">
                    <div class="display_grid gap_px_020" data-xx="1fr 1fr 1fr">
                        <?php if (!empty($flat_my_posts)): ?>
                            <?php 
                            // 화면에는 최대 9개만 표시
                            $display_posts = array_slice($flat_my_posts, 0, 9);
                            ...
                            <?php endforeach; ?>
                            <?php
                            $remaining = 9 - count($flat_my_posts);
