    ...
    <div class="flex_fl width_box height_box padding_px-l_200" data-xy="1-1200: flex_ft padding_px-l_000">
        ...
        <div class="width_box height_box padding_px-a_020" data-bg-color="#E6E6E5">
            <div class="flex_xs1_yc padding_px-u_020"
                ...
                <div class="font_px_020 flv6">적립금소멸</div>
                <div class="flex_xc" data-xy="1-800: flex_xr, 801-1200: flex_xc">
                    <div class="flex_xs1_yc width_px_300 font_px_016 padding_px-u_000" data-color="#888888"
                        ...
                        <div>리워드</div>
                        <div>></div>
                        <div class="flv6" data-color="#000000">적립금소멸</div>
                    </div>
                </div>
            </div>
            <div class="flex_ft width_box border_px-a_002 font_px_016" data-bd-a-color="#d9d9d9"
                    ...
                    <div class="flex_fl_yc height_px_055 border_px-u_001 padding_px-x_010 padding_px-y_010 width_box height_box"
                        ...
                        <div class="flex_fl_yc min_width_310 width_px_310 padding_px-u_000"
                            ...
                            <input class="width_px_018 height_px_018 border_px-a_001" data-bd-a-color="#888888"
                                type="radio" name="crm_member_reward_extinction_point" id="crm_member_reward_extinction_point_today"
                                data-xy="1-800: width_px_016 height_px_016">
                            <label class="padding_px-l_005 padding_px-r_020" for="crm_member_reward_extinction_point_today"
                                data-xy="1-800: padding_px-r_010">오늘</label>
                            <input class="width_px_018 height_px_018 border_px-a_001" data-bd-a-color="#888888"
                                type="radio" name="crm_member_reward_extinction_point" id="crm_member_reward_extinction_point_3day"
                                data-xy="1-800: width_px_016 height_px_016">
                            <label class="padding_px-l_005 padding_px-r_020" for="crm_member_reward_extinction_point_3day"
                                data-xy="1-800: padding_px-r_010">3일</label>
                            <input class="width_px_018 height_px_018 border_px-a_001" data-bd-a-color="#888888"
                                type="radio" name="crm_member_reward_extinction_point" id="crm_member_reward_extinction_point_7day"
                                data-xy="1-800: width_px_016 height_px_016">
                            <label class="padding_px-l_005 padding_px-r_020" for="crm_member_reward_extinction_point_7day"
                                data-xy="1-800: padding_px-r_010">7일</label>
                            <input class="width_px_018 height_px_018 border_px-a_001" data-bd-a-color="#888888"
                                type="radio" name="crm_member_reward_extinction_point"
                                id="crm_member_reward_extinction_point_period_search"
                                data-xy="1-800: width_px_016 height_px_016">
                            <label class="padding_px-l_005 padding_px-r_020"
                                for="crm_member_reward_extinction_point_period_search"
                ...
                <script nonce="<?php echo NONCE; ?>">
                    document.addEventListener('DOMContentLoaded', function () {
                        ...
                        // 라디오 버튼과 기간 선택 요소
                        const radioButtons = document.querySelectorAll('input[name="crm_member_reward_extinction_point"]');
                        const yearSelects = [
                        ...
                        radioButtons.forEach(radio => {
                            radio.addEventListener('change', function () {
                                ...
                                if (value === 'crm_member_reward_extinction_point_today') {
                                    setDate(date1, date2, yearSelects, monthSelects, daySelects);
                                } else if (value === 'crm_member_reward_extinction_point_3day') {
                                    date1.setDate(today.getDate() - 3); // 첫 번째 그룹은 3일 전
                                    setDate(date1, date2, yearSelects, monthSelects, daySelects);
                                } else if (value === 'crm_member_reward_extinction_point_7day') {
            ...
            <div class="font_px_020 flv6 padding_px-y_020">소멸대상 적립금 통계</div>
