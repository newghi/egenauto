...
if (isset($user_login)) {
    ...
    echo "<script nonce=" . NONCE . " type='text/javascript'>window.location.href='" . DOMAIN . '/page/blog_board_view/?uniq_id=' . $uniq_id . "'; </script>";
    exit;
}
...
<section class="position1 width_box height_box">
    <div class="padding_px-x_010">
        <div class="width_px_720 margin_x_auto padding_px-y_050" data-xy="1-800: width_box">
            ...
            // SQL 쿼리 작성 (like_status가 1인 갯수 조회)
          ...
          AND like_status = 1";
            ...
            // SQL 쿼리 작성 (scrap_status가 1인 갯수 조회)
                    ...
                    for ($i = 0; $i < min(3, $post_count); $i++) {
                        ...
                        if (!empty($posts_data) && isset($posts_data[0])) {
                            ...
                            <a class="padding_px-a_010"
                                href="<?php echo DOMAIN . '/page/blog_board_preview/?uniq_id=' . $post['uniq_id']; ?>">
...
//댓글 출력
//프로팅 출력
 auto_comment('egb_comment_blog', $uniq_id, $user_uniq_id); 
