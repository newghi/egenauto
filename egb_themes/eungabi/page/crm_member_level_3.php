...
<section class="position1 width_box height_box">
    <div class="flex_fl width_box height_box padding_px-l_200" data-xy="1-1200: flex_ft padding_px-l_000">
        ...
        <div class="width_box height_box padding_px-a_020" data-bg-color="#E6E6E5">
            ...
            <div class="flex_ft width_box border_px-a_002 font_px_016" data-bd-a-color="#d9d9d9"
                ...
                <div class="flex_fl_yc width_box"
                    ...
                    <div class="flex_fl_yc height_px_055 border_px-u_001 padding_px-x_010 padding_px-y_010 width_box height_box"
                        ...
                        <?php
                        // 등급 정보 조회 - 쇼핑몰 타입만 필터링
                        $query = "SELECT * FROM auto_user_grade WHERE is_status = 1 AND grade_type = 'shopping' ORDER BY display_order ASC";
            ...
            <div class="font_px_020 flv6 padding_px-y_020">주문회원조회 결과</div>
                ...
                <div class="scrolls width_box overflow_hidden">
                    <div class="flex_ft border_px-a_001 min_width_1300" data-bd-a-color="#d9d9d9">
                        ...
                        <div class="grid_xx border_px-u_001 bd-a-color-d9d9d9 bg-color-ffffff xx-5per-5per-12per-10per-12per-12per-11per-10per-10per-8per-5per" data-xx="5% 5% 12% 10% 12% 12% 11% 10% 10% 8% 5%" data-bd-a-color="#d9d9d9" data-bg-color="#ffffff">
                            ...
                            <div class="flex_xc border_px-r_001 padding_px-y_015 bd-a-color-d9d9d9" data-bd-a-color="#d9d9d9"><?php echo isset($result['user_shopping_mall_type']) ? htmlspecialchars($result['user_shopping_mall_type']) : '-'; ?></div>
                            <div class="flex_xc border_px-r_001 padding_px-y_015 bd-a-color-d9d9d9" data-bd-a-color="#d9d9d9"><?php echo isset($result['user_etc1']) ? htmlspecialchars($result['user_etc1']) : '-'; ?></div>
                            <div class="flex_xc border_px-r_001 padding_px-y_015 bd-a-color-d9d9d9" data-bd-a-color="#d9d9d9"><?php echo isset($result['user_etc2']) ? number_format($result['user_etc2']) : '-'; ?></div>
                            ...
                            <div class="flex_xc border_px-r_001 padding_px-y_015 bd-a-color-d9d9d9" data-bd-a-color="#d9d9d9"><?php echo isset($result['user_etc3']) ? $result['user_etc3'] . '건' : '-'; ?></div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('egen_search').addEventListener('click', function(e) {
        ...
        window.location.href = '/page/crm_member_level_3/?' + queryParams.toString();
    });
