    ...
    <div class="flex_fl width_box height_box padding_px-l_200" data-xy="1-1200: flex_ft padding_px-l_000">
        ...
        <div class="width_box height_box padding_px-a_020" data-bg-color="#E6E6E5">
            <div class="flex_xs1_yc padding_px-u_020"
                ...
                <div class="font_px_020 flv6">등급별 결제금액 설정</div>
                <div class="flex_xc" data-xy="1-800: flex_xr, 801-1200: flex_xc">
                    <div class="flex_xs1_yc width_px_300 font_px_016 padding_px-u_000" data-color="#888888"
                        ...
                        <div>회원관리</div>
                        <div>></div>
                        <div class="flv6" data-color="#000000">등급별결제관리</div>
                    </div>
                </div>
            </div>
            <div class="width_box border_px-a_002 font_px_016" data-bd-a-color="#d9d9d9"
                ...
                if (empty($grades[0])) {
                    ...
                    foreach ($grades[0] as $grade) {
                        ...
                        // 숫자 포맷팅 전에 콤마 제거 및 float로 변환
                        $payment_amount = $grade['payment_amount'] ? number_format((float)str_replace(',', '', $grade['payment_amount'])) : '0';
                        ?>
                        <div class="flex_fl_yc width_box" data-xy="1-800: flex_ft" data-bg-color="#ffffff">
                            <div class="min_width_180 padding_px-y_018 padding_px-l_010 border_px-r_001 border_px-u_001 flv6"
                                ...
                                data-xy="1-800: padding_px-y_010 padding_px-l_010"><?php echo htmlspecialchars($grade_name); ?></div>
                            <div class="flex_fl_yc border_px-u_001 padding_px-x_010 padding_px-y_010 width_box height_box"
                                ...
                                <form id="payment_form_<?php echo $grade_id; ?>" action="<?php echo DOMAIN . '/?post=grade_payment_amount_form_input'; ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="flex_fl_yc">
                                        <input class="width_px_400 padding_px-y_008 padding_px-x_015 font_px_014 border_px-a_001"
                                            data-bd-a-color="#888888" type="text" name="payment_amount" 
                                            id="payment_amount_<?php echo $grade_id; ?>" value="<?php echo $payment_amount; ?>"
                                            data-xy="1-800: width_box font_px_012" style="text-align: right;">
                                        <div class="font_px_014 min_width_030 flex_xc">원</div>
                                        <div class="padding_px-l_010 flex_xc_yc font_px_012 pointer egb_submit">
                                            <div class="padding_px-x_010 padding_px-y_005 white-_space_nowrap" data-color="#ffffff"
            ...
            <div class="font_px_020 flv6 padding_px-y_020">등급별 결제 내역</div>
            <div class="width_box border_px-a_002 font_px_016" data-bd-a-color="#d9d9d9" data-bg-color="#ffffff"
                    ...
                    <div class="flex_fl_yc height_px_055 border_px-u_001 padding_px-x_010 padding_px-y_010 width_box height_box"
                        ...
                        <div class="flex_fl_yc padding_px-y_000" data-xy="1-1000: padding_px-y_005">
                            <input class="width_px_018 height_px_018 border_px-a_001" data-bd-a-color="#888888"
                                type="radio" name="crm_member_level_level" id="crm_member_level_level_all"
                                data-xy="1-800: width_px_016 height_px_016">
                            <label class="padding_px-l_005 padding_px-r_010" for="crm_member_level_level_all">전체</label>
                        </div>
                        <?php
                        // auto_user_grade 테이블에서 커뮤니티 등급 가져오기
                        $query = "SELECT * FROM auto_user_grade WHERE is_status = 1 AND grade_type = 'community' ORDER BY display_order ASC";
                        $binding = binding_sql(0, $query, []);
                        $grades = egb_sql($binding);
                        ...
                        if (!empty($grades[0])) {
                            foreach ($grades[0] as $grade) {
                                ...
                                <div class="flex_fl_yc padding_px-y_000" data-xy="1-1000: padding_px-y_005">
                                    <input class="width_px_018 height_px_018 border_px-a_001" data-bd-a-color="#888888"
                                        type="radio" name="crm_member_level_level" id="crm_member_level_level_<?php echo $grade_id; ?>"
                                        data-xy="1-800: width_px_016 height_px_016">
                                    <label class="padding_px-l_005 padding_px-r_010"
                                        for="crm_member_level_level_<?php echo $grade_id; ?>"><?php echo htmlspecialchars($grade_name); ?></label>
                                </div>
                                <?php
                            }
                        }
                ...
                <div class="flex_fl_yc width_box height_box"
                    ...
                    <div class="flex_fl_yc height_px_055 border_px-u_001 padding_px-x_010 padding_px-y_010 width_box height_box"
                        ...
                        <div class="flex_fl_yc min_width_310 width_px_310 padding_px-u_000"
                            ...
                            <input class="width_px_018 height_px_018 border_px-a_001" data-bd-a-color="#888888"
                                type="radio" name="crm_member_level_paymentday" id="crm_member_level_paymentday_today"
                                data-xy="1-800: width_px_016 height_px_016">
                            <label class="padding_px-l_005 padding_px-r_020" for="crm_member_level_paymentday_today"
                                data-xy="1-800: padding_px-r_010">오늘</label>
                            <input class="width_px_018 height_px_018 border_px-a_001" data-bd-a-color="#888888"
                                type="radio" name="crm_member_level_paymentday" id="crm_member_level_paymentday_3day"
                                data-xy="1-800: width_px_016 height_px_016">
                            <label class="padding_px-l_005 padding_px-r_020" for="crm_member_level_paymentday_3day"
                                data-xy="1-800: padding_px-r_010">3일</label>
                            <input class="width_px_018 height_px_018 border_px-a_001" data-bd-a-color="#888888"
                                type="radio" name="crm_member_level_paymentday" id="crm_member_level_paymentday_7day"
                                data-xy="1-800: width_px_016 height_px_016">
                            <label class="padding_px-l_005 padding_px-r_020" for="crm_member_level_paymentday_7day"
                                data-xy="1-800: padding_px-r_010">7일</label>
                            <input class="width_px_018 height_px_018 border_px-a_001" data-bd-a-color="#888888"
                                type="radio" name="crm_member_level_paymentday"
                                id="crm_member_level_paymentday_period_search"
                                data-xy="1-800: width_px_016 height_px_016">
                            <label class="padding_px-l_005 padding_px-r_020"
                                for="crm_member_level_paymentday_period_search"
                        ...
                        <div class="flex_fl_yc width_box height_box" data-bg-color="#ffffff" data-xy="1-1200: flex_ft">
                            <div class="flex_fl_yc" data-xy="1-1200: width_box">
                                <div class="flex_fl_yc" data-xy="1-800: width_box">
                                    <select id="crm_member_level_year_1" name=""
                                        class="width_px_080 padding_px-y_008 padding_px-x_005 font_px_014 border_px-a_001 crm_member_level_year_1"
                                ...
                                <div class="flex_fl_yc" data-xy="1-800: width_box">
                                    <select id="crm_member_level_month_1" name=""
                                        class="width_px_080 padding_px-y_008 padding_px-x_005 font_px_014 border_px-a_001 crm_member_level_month_1"
                                ...
                                <div class="flex_fl_yc" data-xy="1-800: width_box">
                                    <select id="crm_member_level_day_1" name=""
                                        class="width_px_080 padding_px-y_008 padding_px-x_005 font_px_014 border_px-a_001 crm_member_level_day_1"
                            ...
                            <div class="flex_fl_yc" data-xy="1-1200: width_box">
                                <div class="flex_fl_yc" data-xy="1-800: width_box">
                                    <select id="crm_member_level_year_2" name=""
                                        class="width_px_080 padding_px-y_008 padding_px-x_005 font_px_014 border_px-a_001 crm_member_level_year_2"
                                        data-bd-a-color="#888888" data-xy="1-800: width_box font_px_012 min_width_065">
                                        <option value="선택" selected hidden disabled>선택</option>
                                    </select>
                                    <div class="padding_px-l_005 padding_px-r_015"
                                ...
                                <div class="flex_fl_yc" data-xy="1-800: width_box">
                                    <select id="crm_member_level_month_2" name=""
                                        class="width_px_080 padding_px-y_008 padding_px-x_005 font_px_014 border_px-a_001 crm_member_level_month_2"
                                        data-bd-a-color="#888888" data-xy="1-800: width_box font_px_012 min_width_060">
                                        <option value="선택" selected hidden disabled>선택</option>
                                        <option value="1">1</option>
                                        <option value="2">2</option>
                                ...
                                <div class="flex_fl_yc" data-xy="1-800: width_box">
                                    <select id="crm_member_level_day_2" name=""
                                        class="width_px_080 padding_px-y_008 padding_px-x_005 font_px_014 border_px-a_001 crm_member_level_day_2"
                                        data-bd-a-color="#888888" data-xy="1-800: width_box font_px_012">
                                        <option value="선택" selected hidden disabled>선택</option>
                                    </select>
                                    <div class="padding_px-l_005">일</div>
                ...
                <script nonce="<?php echo NONCE; ?>">
                    document.addEventListener('DOMContentLoaded', function () {
                        ...
                        // 라디오 버튼과 기간 선택 요소
                        const radioButtons = document.querySelectorAll('input[name="crm_member_level_paymentday"]');
                        const yearSelects = [
                            document.getElementById('crm_member_level_year_1'),
                            document.getElementById('crm_member_level_year_2'),
                        ];
                        const monthSelects = [
                            document.getElementById('crm_member_level_month_1'),
                            document.getElementById('crm_member_level_month_2'),
                        ];
                        const daySelects = [
                            document.getElementById('crm_member_level_day_1'),
                            document.getElementById('crm_member_level_day_2'),
                        ];
                        ...
                        radioButtons.forEach(radio => {
                            radio.addEventListener('change', function () {
                                ...
                                if (value === 'crm_member_level_paymentday_today') {
                                    setDate(date1, date2, yearSelects, monthSelects, daySelects);
                                } else if (value === 'crm_member_level_paymentday_3day') {
                                    date1.setDate(today.getDate() - 3); // 첫 번째 그룹은 3일 전
                                    setDate(date1, date2, yearSelects, monthSelects, daySelects);
                                } else if (value === 'crm_member_level_paymentday_7day') {
                ...
                <div class="flex_xc padding_px-t_010 padding_px-u_020" data-bg-color="#e6e6e5">
                    <div id="search_button" class="border_px-a_001 padding_px-x_030 padding_px-y_015 font_px_018 pointer"
                ...
                <div class="scrolls width_box overflow_hidden">
                    <div class="flex_ft border_px-a_001 min_width_1300" data-bd-a-color="#d9d9d9">
                        <div class="grid_xx border_px-u_001 flv6" data-xx="5% 5% 12% 10% 12% 12% 11% 10% 10% 8% 5%"
                            ...
                            <div class="flex_xc border_px-r_001 padding_px-y_015" data-bd-a-color="#d9d9d9">최근결제일</div>
                            ...
                            <div class="flex_xc border_px-r_001 padding_px-y_015" data-bd-a-color="#d9d9d9">등급</div>
                        ...
                        <div class="grid_xx border_px-u_001" data-xx="5% 5% 12% 10% 12% 12% 11% 10% 10% 8% 5%"
                            data-bd-a-color="#d9d9d9" data-bg-color="#ffffff">
                            <label for="crm_searching_member_level_1"
                                class="flex_xc border_px-r_001 padding_px-y_015 pointer" data-bd-a-color="#d9d9d9">
                                <input class="border_px-a_001 width_px_020 height_px_020" dat type="levelbox" name=""
                                    id="crm_searching_member_level_1" data-bd-a-color="#d9d9d9">
                            </label>
                            ...
                            <div class="flex_xc border_px-r_001 padding_px-y_015" data-bd-a-color="#d9d9d9">멘토</div>
                            <div class="flex_xc border_px-r_001 padding_px-y_015" data-bd-a-color="#d9d9d9">신용카드</div>
                            <div class="flex_xc border_px-r_001 padding_px-y_015" data-bd-a-color="#d9d9d9">947,800
                            </div>
                            <div class="flex_xc border_px-r_001 padding_px-y_015" data-bd-a-color="#d9d9d9">개인회원</div>
                            <div class="flex_xc border_px-r_001 padding_px-y_015" data-bd-a-color="#d9d9d9">33건</div>
                        ...
                        <div class="grid_xx border_px-u_001" data-xx="5% 5% 12% 10% 12% 12% 11% 10% 10% 8% 5%"
                            data-bd-a-color="#d9d9d9" data-bg-color="#ffffff">
                            <label for="crm_searching_member_level_2"
                                class="flex_xc border_px-r_001 padding_px-y_015 pointer" data-bd-a-color="#d9d9d9">
                                <input class="border_px-a_001 width_px_020 height_px_020" dat type="levelbox" name=""
                                    id="crm_searching_member_level_2" data-bd-a-color="#d9d9d9">
                            </label>
                            ...
                            <div class="flex_xc border_px-r_001 padding_px-y_015" data-bd-a-color="#d9d9d9">멘티</div>
                            <div class="flex_xc border_px-r_001 padding_px-y_015" data-bd-a-color="#d9d9d9">계좌이체</div>
                            <div class="flex_xc border_px-r_001 padding_px-y_015" data-bd-a-color="#d9d9d9">857,200
                            </div>
                            <div class="flex_xc border_px-r_001 padding_px-y_015" data-bd-a-color="#d9d9d9">개인회원</div>
                            <div class="flex_xc border_px-r_001 padding_px-y_015" data-bd-a-color="#d9d9d9">21건</div>
                            <div class="flex_xc padding_px-y_015 pointer" data-bd-a-color="#d9d9d9" data-hover-bg-color="#15376b" data-hover-color="#ffffff">보기</div>
                        </div>
                        <div class="grid_xx border_px-u_001" data-xx="5% 5% 12% 10% 12% 12% 11% 10% 10% 8% 5%"
                            data-bd-a-color="#d9d9d9" data-bg-color="#ffffff">
                            <label for="crm_searching_member_level_3"
                                class="flex_xc border_px-r_001 padding_px-y_015 pointer" data-bd-a-color="#d9d9d9">
                                <input class="border_px-a_001 width_px_020 height_px_020" dat type="levelbox" name=""
                                    id="crm_searching_member_level_3" data-bd-a-color="#d9d9d9">
                            </label>
                            <div class="flex_xc_yc border_px-r_001 padding_px-y_015" data-bd-a-color="#d9d9d9">3
                            </div>
                            <div class="flex_xc border_px-r_001 padding_px-y_015" data-bd-a-color="#d9d9d9">
                                2024-06-01
                            </div>
                            ...
                            <div class="flex_xc border_px-r_001 padding_px-y_015" data-bd-a-color="#d9d9d9">멘티</div>
                            <div class="flex_xc border_px-r_001 padding_px-y_015" data-bd-a-color="#d9d9d9">신용카드</div>
                            <div class="flex_xc border_px-r_001 padding_px-y_015" data-bd-a-color="#d9d9d9">735,100
                            </div>
                            <div class="flex_xc border_px-r_001 padding_px-y_015" data-bd-a-color="#d9d9d9">개인회원</div>
                            <div class="flex_xc border_px-r_001 padding_px-y_015" data-bd-a-color="#d9d9d9">13건</div>
                            <div class="flex_xc padding_px-y_015 pointer" data-bd-a-color="#d9d9d9" data-hover-bg-color="#15376b" data-hover-color="#ffffff">보기</div>
                        </div>
                    </div>
                </div>
...
<script nonce="<?php echo NONCE; ?>">
    ...
    for (let i = 1; i <= groupCount; i++) {
        dateGroups.push({
            year: document.querySelector(`.crm_member_level_year_${i}`),
            month: document.querySelector(`.crm_member_level_month_${i}`),
            day: document.querySelector(`.crm_member_level_day_${i}`)
        });
    }
