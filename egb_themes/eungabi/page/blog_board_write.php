<form class="position1" action="<?php echo DOMAIN . '/?post=blog_form_input'; ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="width_px_800 margin_x_auto padding_px-t_020" data-xy="1-800: width_box">
            <div class="padding_px-x_000" data-xy="1-800: padding_px-x_020">
                <div class="flex_ft_xc_yc border_bre-a_005 width_box min_height_500 height_box font_px_016 font_style_center"
                    ...
                    <div class="flex_ft_xc_yc blog_img_box width_box min_height_500 border_bre-a_005 overflow_hidden"
                        data-xy="1-800: min_height_200">
                        <input type="file" name="images" id="blog_image_upload" accept="image/*" class="img_files" style="position: absolute; width: 1px; height: 1px; padding: 0; margin: -1px; overflow: hidden; clip: rect(0,0,0,0); border: 0;" required>
                        <img class="blog_img width_px_025 height_px_025"
                            src="<?php echo DOMAIN . THEMES_PATH . '/img/icon/camera.svg'; ?>">
                        <div class="padding_px-t_010">
                            <label for="blog_image_upload" class="blog_contents_img_upload_button filechoice border_bre-a_005 padding_px-y_015 padding_px-x_025 flv6 pointer"
                                data-bg-color="#15376b" data-color="#ffffff">썸네일 이미지 등록</label>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="position1 width_box">
        <div class="width_px_800 margin_x_auto padding_px-t_020" data-xy="1-800: width_box">
            <div class="padding_px-x_000" data-xy="1-800: padding_px-x_020">
                <div class="blog_content border_bre-a_005 width_box height_px_500 flex_ft_yc font_px_016"
                    data-bg-color="#ffffff">
                    <div class="position1 width_box flex_ft_yc font_px_018 flv6 border_px-u_001 budget2"
                        data-bd-a-color="#dddddd">
                        <input type="text" name="titles"
                            class="blog_content_title padding_px-x_025 padding_px-y_015 font_px_025 flv6 width_box nothover"
                    ...
                    <div class="width_box flex_ft_yc font_px_018 flv6 padding_px-t_015">
                        <textarea id="egbeditor2" name="contents" 
                            class="blog_content_content padding_px-x_025 padding_px-y_015 width_box"
                            required></textarea>
                    </div>
                </div>
            </div>
...
<script nonce="<?php echo NONCE; ?>">
    document.addEventListener("DOMContentLoaded", function () {
        const uploadButton = document.querySelector(".blog_contents_img_upload_button");
        const fileInput = document.querySelector(".img_files");
        const imgBox = document.querySelector(".blog_img_box");
        const imgElement = imgBox.querySelector(".blog_img");
        ...
        function handleFileSelect(e) {
            ...
            reader.onload = function(e) {
                ...
                Array.from(imgBox.children).forEach(child => {
                    if (!child.classList.contains("blog_img")) {
        ...
        document.querySelector("form").addEventListener("submit", function(e) {
            ...
            const title = document.querySelector('input[name="titles"]');
            const content = document.querySelector('textarea[name="contents"]');
