...
<section class="position1 width_box height_box">
    ...
    <div class="width_px_320 margin_x_auto padding_px-y_150">
        <div class="font_px_020 flv6 font_style_center" data-color="#424242">아이디 찾기
        </div>
        <div class="padding_px-t_050">
            <form class="padding_px-x_010">
                ...
                <div id="find_id_1" class="box display_none width_box">
                    <div class="flex_fl_yc padding_px-t_010 padding_px-u_030">
                        <div class="">
                            <label class="flex_yc font_px_013 padding_px-l_005 pointer" for="find_id_email"><input
                                    type="radio" class="width_px_012 height_px_012 pointer margin_px-r_005"
                                    id="find_id_email" name="find_id" checked>이메일</label>
                        </div>
                        <div class="padding_px-l_015">
                            <label class="flex_yc font_px_013 padding_px-l_005 pointer" for="find_id_phone"><input
                                    type="radio" class="width_px_012 height_px_012 pointer margin_px-r_005"
                                    id="find_id_phone" name="find_id">휴대전화</label>
                        </div>
                    </div>
                    <div id="find_id_1a" class="display_none">
                    ...
                    <div id="find_id_1b" class="display_none">
                        <div class="flex_yc width_box font_px_020 flv6 padding_px-u_005">
                            휴대전화로 아이디 찾기</div>
                ...
                <div id="find_id_2" class="box display_none width_box">
                    <div class="flex_fl_yc padding_px-t_010 padding_px-u_030">
                        <div class="">
                            <label class="flex_yc font_px_013 padding_px-l_005 pointer" for="find_id_email_2"><input
                                    type="radio" class="width_px_012 height_px_012 pointer margin_px-r_005"
                                    id="find_id_email_2" name="find_id_2" checked>이메일</label>
                        </div>
                        <div class="padding_px-l_015">
                            <label class="flex_yc font_px_013 padding_px-l_005 pointer" for="find_id_phone_2"><input
                                    type="radio" class="width_px_012 height_px_012 pointer margin_px-r_005"
                                    id="find_id_phone_2" name="find_id_2">휴대전화</label>
                        </div>
                    </div>
                    <div id="find_id_2a" class="display_none">
                        <div class="flex_yc width_box font_px_020 flv6 padding_px-u_005">
                            이메일로 아이디 찾기</div>
                        <div class="position1 flex_xc_yc width_box">
                            <input name=""
                    ...
                    <div id="find_id_2b" class="display_none">
                        <div class="flex_yc width_box font_px_020 flv6 padding_px-u_005">
                            휴대전화로 아이디 찾기</div>
                        <div class="position1 flex_fl_yc width_box">
                            <input name=""
                                class="width_px_043 height_px_040 font_px_015 fontstyle1 border_bre-a_004 padding_px-x_015 border_px-a_001"
                                data-bd-a-color="#dbdbdb" type="text">
                            <div class="padding_px-r_005"></div>
                            <input name=""
                                class="width_px_043 height_px_040 font_px_015 fontstyle1 border_bre-a_004 padding_px-x_015 border_px-a_001"
                            ...
                            <input name=""
                                ...
                                data-bd-a-color="#dbdbdb" type="text">
                            <div class="padding_px-r_005"></div>
                            <div class="width_px_060 height_px_042">
                                <div class="pointer flex_ft_xc_yc width_box height_box font_px_010 border_bre-a_004 fontstyle1 check"
                                    data-bg-color="#202020" data-color="#ffffff">
                                    <span data-color="#ffffff">인증번호</span>
                                    <span data-color="#ffffff">발송</span>
                ...
                <div id="find_id_3" class="box display_none width_box">
                    <div class="flex_fl_yc padding_px-t_010 padding_px-u_030">
                        <div class="">
                            <label class="flex_yc font_px_013 padding_px-l_005 pointer" for="find_id_number_3"><input
                                    type="radio" class="width_px_012 height_px_012 pointer margin_px-r_005"
                                    id="find_id_number_3" name="find_id_3" checked>법인번호</label>
                        </div>
                        <div class="padding_px-l_015">
                            <label class="flex_yc font_px_013 padding_px-l_005 pointer" for="find_id_email_3"><input
                                    type="radio" class="width_px_012 height_px_012 pointer margin_px-r_005"
                                    id="find_id_email_3" name="find_id_3">이메일</label>
                        </div>
                        <div class="padding_px-l_015">
                            <label class="flex_yc font_px_013 padding_px-l_005 pointer" for="find_id_phone_3"><input
                                    type="radio" class="width_px_012 height_px_012 pointer margin_px-r_005"
                                    id="find_id_phone_3" name="find_id_3">휴대전화</label>
                        </div>
                    </div>
                    <div id="find_id_3a" class="display_none">
                        <div class="flex_yc width_box font_px_020 flv6 padding_px-u_005">
                            법인번호로 아이디 찾기</div>
                        ...
                        <div class="flex_fl_yc width_box margin_px-t_010">
                            <input name=""
                                class="width_px_113 height_px_040 font_px_015 fontstyle1 border_bre-a_004 padding_px-x_015 border_px-a_001"
                                data-bd-a-color="#dbdbdb" type="text">
                    ...
                    <div id="find_id_3b" class="display_none">
                        <div class="flex_yc width_box font_px_020 flv6 padding_px-u_005">
                            이메일로 아이디 찾기</div>
                        <div class="position1 flex_xc_yc width_box">
                            <input name=""
                    ...
                    <div id="find_id_3c" class="display_none">
                        <div class="flex_yc width_box font_px_020 flv6 padding_px-u_005">
                            휴대전화로 아이디 찾기</div>
                        <div class="position1 flex_fl_yc width_box">
                            <input name=""
                ...
                <div class="width_box flex_xc_yc padding_px-t_050">
                    <input
                        class="check width_box border_bre-a_004 flex_xc_yc height_px_048 font_style_center border_px-a_001 pointer font_px_016"
                        data-bg-color="#202020" data-color="#ffffff" data-bd-a-color="#ffffff" value="아이디 찾기"
                        type="submit">
                </div>
            </form>
        </div>
...
<script nonce="<?php echo NONCE; ?>">
    document.addEventListener('DOMContentLoaded', function () {
        var optionSelect = document.getElementById('findidselect');
        var boxA = document.getElementById('find_id_1');
        var boxAEmail = document.getElementById('find_id_1a');
        var boxAPhone = document.getElementById('find_id_1b');
        var boxB = document.getElementById('find_id_2');
        var boxBEmail = document.getElementById('find_id_2a');
        var boxBPhone = document.getElementById('find_id_2b');
        var boxC = document.getElementById('find_id_3');
        var boxCNumber = document.getElementById('find_id_3a');
        var boxCEmail = document.getElementById('find_id_3b');
        var boxCPhone = document.getElementById('find_id_3c');
        ...
        function updateVisibilityBasedOnSelection() {
            ...
            if (selectedValue === '개인회원') {
                ...
                var emailRadio = document.getElementById('find_id_email');
                var phoneRadio = document.getElementById('find_id_phone');
                ...
                var emailRadioB = document.getElementById('find_id_email_2');
                var phoneRadioB = document.getElementById('find_id_phone_2');
                ...
                var numberRadioC = document.getElementById('find_id_number_3');
                var emailRadioC = document.getElementById('find_id_email_3');
                var phoneRadioC = document.getElementById('find_id_phone_3');
        ...
        function removeAllRequired() {
            var allInputs = document.querySelectorAll('#find_id_1 input, #find_id_1a input, #find_id_1b input, #find_id_2 input, #find_id_2a input, #find_id_2b input, #find_id_3 input, #find_id_3a input, #find_id_3b input, #find_id_3c input');
