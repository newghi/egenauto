...
function egb_board_list($board_name) {
	...
	if(isset($sql4[0]['board_mangement_board_themes'])){
		require_once ROOT.'/egb_setting/egb_board/themes/'.$sql4[0]['board_mangement_board_themes'].'/egb_board_list.php';
	}else{
		require_once ROOT.'/egb_setting/egb_board/themes/default/egb_board_list.php';
	}
}
?>
