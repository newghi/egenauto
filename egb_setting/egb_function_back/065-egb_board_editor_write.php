...
function egb_board_editoer_write($board_name) {
	...
	if(isset($sql4[0]['board_mangement_board_editor'])){
		require_once ROOT.'/egb_setting/egb_board/editor/'.$sql4[0]['board_mangement_board_editor'].'/egb_board_editoer_write.php';
	}else{
		require_once ROOT.'/egb_setting/egb_board/editor/smarteditor2/egb_board_editoer_write.php';
	}
}
?>
