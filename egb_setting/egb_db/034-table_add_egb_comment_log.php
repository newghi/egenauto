<?php
function table_add_egb_comment_log() {
	$query_db = "
CREATE TABLE IF NOT EXISTS egb_comment_log (
    ...
    log_comment_uniq_id VARCHAR(13) NOT NULL COMMENT '작성된 댓글 유니크ID',
    log_user_uniq_id VARCHAR(13) NOT NULL COMMENT '댓글 작성자 ID',
    ...
    INDEX `idx_log_comment` (`log_target_table`, `log_comment_uniq_id`),
    INDEX `idx_log_created_at` (`created_at`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='댓글 로그 테이블';
";
