...
<header class="position1  z-index_2">
    <div class="position3 width_box" data-top="0%">
        <div class="flex_fl_yc width_box height_px_050" data-bg-color="#cccccc70">
            <div class="padding_px-a_010 width_px_050 height_px_050 border_px-u_003 pointer"
                data-bd-a-color="transparent" data-hover-bg-color="#cccccc40">
                <div clas="width_px_030 height_px_030">
                    <svg class="svg_shadow" height="100%" viewBox="0 0 32 32" width="100%"
            ...
            <div class="padding_px-a_010 width_px_050 height_px_050 border_px-u_003 pointer" data-bd-a-color="#ffffff"
                data-bg-color="#cccccc40" data-hover-bg-color="#cccccc40">
                <div clas="width_px_030 height_px_030">
                    <svg class="svg_shadow" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
