<?php
//바탕화면 폴더 이름
$egb_folder_name = 'setting';
//바탕화면 메뉴 이름
$egb_title_name = '사이트 설정';
//바탕화면 아이콘
$folder_icon_svg = '
<svg class="svg_shadow" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="100%" height="100%" viewBox="0 0 512 512" xml:space="preserve" style="enable-background:new 0 0 512 512;">
    ...
    <linearGradient id="SVGID_3_" gradientUnits="userSpaceOnUse" x1="-15.0449" y1="586.5254" x2="-15.0449" y2="632.5254" gradientTransform="matrix(8.9825 0 0 -8.9825 391.1404 5726.5439)">
        <stop offset="0" style="stop-color:#414142"/>
        <stop offset="1" style="stop-color:#282829"/>
    </linearGradient>
    <circle style="fill:url(#SVGID_3_);" cx="256" cy="251.509" r="206.596"/>
    <linearGradient id="SVGID_4_" gradientUnits="userSpaceOnUse" x1="-26.0449" y1="559.5254" x2="-4.0449" y2="559.5254" gradientTransform="matrix(8.9825 0 0 -8.9825 391.1404 5726.5439)">
    ...
    <linearGradient id="SVGID_5_" gradientUnits="userSpaceOnUse" x1="-10.0699" y1="599.291" x2="-27.5699" y2="635.291" gradientTransform="matrix(8.9825 0 0 -8.9825 391.1404 5726.5439)">
        <stop offset="0" style="stop-color:#CCCCCE"/>
        <stop offset="1" style="stop-color:#E8E8EA"/>
    </linearGradient>
