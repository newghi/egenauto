...
<div class="height_box overflow_y_auto scrollbar">
    <form id="egb_point_add_input" action="<?php echo DOMAIN . '/?post=egb_point_add_input'; ?>" method="post" enctype="multipart/form-data"
    class="position4 width_box font_px_014 padding_px-x_010 padding_px-t_010 z-index_100" data-top="0%" data-bg-color="#ffffff">
        ...
        <input type="hidden" name="filter_table_name" value="egb_point">
        
        <div class="padding_px-t_010 padding_px-x_010 padding_px-u_050">
            <form class="" id="egb_point_add_search_input" action="<?php echo DOMAIN . '/?post=egb_point_user_search_input'; ?>" method="post" enctype="multipart/form-data">
                <input type="hidden" name="csrf_token" value="<?php echo $_SESSION['csrf_token']; ?>">
            <div class="flex_ft padding_px-u_008">
                    <div class="padding_px-u_005">회원</div>
                    <input id="user_keyword_point" class="menu_input_style text_change_submit" type="text" name="user_keyword" placeholder="회원 아이디 입력" required>
                </div>
            </form>
            
            <div id="point_add_search_result" class="padding_px-u_008"></div>
            <div class="flex_ft padding_px-u_008">
                <select class="menu_input_style padding_px-a_005" name="point_target_uniq_id" required>
            ...
            <div class="flex_ft padding_px-u_008">
                ...
                <select class="menu_input_style padding_px-a_005" name="point_type" required>
            ...
            <div class="flex_ft padding_px-u_008">
                ...
                <select class="menu_input_style padding_px-a_005" name="point_reason" required>
                    <option value="회원가입">회원가입</option>
                    <option value="상품구매">상품구매</option>
                    <option value="상품리뷰">상품리뷰</option>
                    <option value="이벤트">이벤트</option>
                    <option value="임의조정" selected>임의조정</option>
                    <option value="포인트소멸">포인트소멸</option>
                </select>
            </div>

            <div class="flex_ft padding_px-u_008">
                <div class="padding_px-u_005">변경 금액</div>
                <input class="menu_input_style" type="text" name="point_amount" placeholder="금액을 입력" required>
            </div>

            <div class="flex_ft padding_px-u_008">
                <div class="padding_px-u_005">메모</div>
                <textarea class="menu_input_style padding_px-x_010 padding_px-y_005" name="point_memo" placeholder="메모를 입력"></textarea>
            </div>
        </div>
    </form>
</div>
...
document.querySelector('input[name="point_amount"]').addEventListener('input', function(e) {
