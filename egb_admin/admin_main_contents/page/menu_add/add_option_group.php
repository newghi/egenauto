...
<form class="height_box overflow_y_auto scrollbar" id="egb_option_group_add_input" action="<?php echo DOMAIN . '/?post=egb_option_group_add_input'; ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="height_box padding_px-t_010 padding_px-x_010 padding_px-u_050">
        <div class="flex_ft padding_px-u_008">
            ...
            <input class="menu_input_style" type="text" name="group_code" pattern="[A-Za-z0-9_]+" title="영문, 숫자, 언더바(_)만 입력 가능합니다" placeholder="영문, 숫자, 언더바(_)만 입력 가능" required>
        </div>
        <div class="flex_ft padding_px-u_008">
            <div class="padding_px-u_005">옵션 그룹 제목</div>
            <input class="menu_input_style" type="text" name="group_title" placeholder="옵션 그룹 제목을 입력하세요" required>
        </div>
        <div class="flex_ft padding_px-u_008">
            <div class="padding_px-u_005">옵션 그룹 설명</div>
            <textarea class="menu_input_style padding_px-a_005" name="group_description" style="min-height: 100px; resize: vertical;" placeholder="옵션 그룹 설명을 입력하세요"></textarea>
        </div>
        <div class="flex_ft padding_px-u_008">
        ...
        <div class="flex_ft padding_px-u_008">
            ...
            <input class="menu_input_style" type="number" name="group_access_level" value="0" min="0" max="99" placeholder="접근 레벨을 입력하세요">
        </div>
        <div class="flex_ft padding_px-u_008">
            <div class="padding_px-u_005">출력 순서</div>
            <input class="menu_input_style" type="number" name="display_order" value="0" min="0" placeholder="출력 순서를 입력하세요">
        </div>
    </div>
</form>