...
<div class="height_box overflow_y_auto scrollbar">
    <form id="egb_mileage_add_input" action="<?php echo DOMAIN . '/?post=egb_mileage_add_input'; ?>" method="post" enctype="multipart/form-data"
    class="position4 width_box font_px_014 padding_px-x_010 padding_px-t_010 z-index_100" data-top="0%" data-bg-color="#ffffff">
        ...
        <input type="hidden" name="filter_table_name" value="egb_mileage">
        
        <div class="padding_px-t_010 padding_px-x_010 padding_px-u_050">
            <form class="" id="egb_mileage_add_search_input" action="<?php echo DOMAIN . '/?post=egb_mileage_user_search_input'; ?>" method="post" enctype="multipart/form-data">
                <input type="hidden" name="csrf_token" value="<?php echo $_SESSION['csrf_token']; ?>">
            <div class="flex_ft padding_px-u_008">
                    <div class="padding_px-u_005">회원</div>
                    <input id="user_keyword_mileage" class="menu_input_style text_change_submit" type="text" name="user_keyword" placeholder="회원 아이디 입력" required>
                </div>
            </form>
            
            <div id="mileage_add_search_result" class="padding_px-u_008"></div>
            <div class="flex_ft padding_px-u_008">
                <select class="menu_input_style padding_px-a_005" name="mileage_target_uniq_id" required>
            ...
            <div class="flex_ft padding_px-u_008">
                ...
                <select class="menu_input_style padding_px-a_005" name="mileage_type" required>
            ...
            <div class="flex_ft padding_px-u_008">
                ...
                <select class="menu_input_style padding_px-a_005" name="mileage_reason" required>
                    <option value="주문취소">주문취소</option>
                    <option value="마일리지환불">마일리지환불</option>
            ...
            <div class="flex_ft padding_px-u_008">
                ...
                <input class="menu_input_style" type="text" name="mileage_amount" placeholder="금액을 입력" required>
            </div>

            <div class="flex_ft padding_px-u_008">
                <div class="padding_px-u_005">메모</div>
                <textarea class="menu_input_style padding_px-x_010 padding_px-y_005" name="mileage_memo" placeholder="메모를 입력"></textarea>
            </div>
        </div>
    </form>
</div>
...
document.querySelector('input[name="mileage_amount"]').addEventListener('input', function(e) {
