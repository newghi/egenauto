    ...
    if (statusSelect) {
        statusSelect.addEventListener('change', function () {
            ...
            <div class="flex_fl_yc <?php echo $page_name; ?>_change_button_filter_off">
                ...
                <div class="padding_px-y_005 padding_px-x_020 border_px-a_001 border_bre-a_005 margin_px-x_010 pointer display_none <?php echo $page_name; ?>_check_edit <?php echo $edit_button; ?>" 
