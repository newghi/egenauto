...
// 테이블 명만 바꾸면 됨
$totalQuery = "SELECT record_total_count FROM egb_record_count WHERE record_table_name = 'egb_page'";
...
$order = egb('order') && in_array(egb('order'), ['asc', 'desc'])
    ? egb('order')
    : 'desc';

$page = egb('page') && intval(egb('page')) > 0
    ? intval(egb('page'))
    : 1;

    // 검색어 처리
    $searchKeyword = isset($_GET['search_input']) ? trim($_GET['search_input']) : '';

        //////////////////////////////////////////

// 데이터 가져오기 쿼리 처리
$query = "SELECT * FROM egb_page WHERE deleted_at IS NULL";

//검색어에 대한 쿼리 처리
if (!empty($searchKeyword)) {
    $query .= " AND banner_title LIKE :search";
...
<div class="display_off" egb:style="
    ...
    input.search_input{width:160px; padding-left:15px; padding-right:37px; padding-top:8px; padding-bottom:8px; border: 1px solid #d9d9d9; font-size:12px; box-sizing: border-box;}
    ...
    .filter_modal {transform: translateX(300px); transition: transform 0.4s;}
...
<div class="position4 z-index_5" data-top="0%" data-left="0%">
    <div class="position1 width_box height_px_040 z-index_5" data-top="0%" data-left="0%" data-bg-color="#ffffff">
        <div class="position4 flex_xs1_yc width_box height_px_040 border_px-u_001 padding_px-x_010 padding_px-y_005"
            ...
            <div class="flex_fl font_px_010">
                <div id="<?php echo $page_name; ?>_excel_format_download_button" class="margin_px-x_003 padding_px-x_008 padding_px-y_005 border_px-a_001 pointer"
                    data-bg-color="#f5f5f5" data-hover-bg-color="#dddddd" data-bd-a-color="#e9e9e9">엑셀 양식다운</div>
                <div id="<?php echo $page_name; ?>_excel_download_button" class="margin_px-x_003 padding_px-x_008 padding_px-y_005 border_px-a_001 pointer"
                    data-bg-color="#f5f5f5" data-hover-bg-color="#dddddd" data-bd-a-color="#e9e9e9">엑셀 다운</div>
                ...
                <div id="<?php echo $page_name; ?>_output_column_button" class="margin_px-x_003 padding_px-x_008 padding_px-y_005 border_px-a_001 pointer"
                    ...
                    egbT('column_<?php echo $page_name; ?>_contents_box', 'id=<?php echo $page_name; ?>_column&path=/admin_main_contents/<?php echo $page_dir; ?>/menu_column/column_<?php echo $page_name; ?>&page_name=<?php echo $page_dir; ?>&menu_name=<?php echo $page_name; ?>', true);">출력항목</div>
            </div>
            <div class="flex_fl">
                <div class="flex_fl_yc">
                    <div class="width_px_038 height_px_032 padding_px-x_009 padding_px-y_006 border_px-a_001 margin_px-r_005 pointer refresh_icon"
						...
						egbT('modal_<?php echo $page_dir; ?>_contents', 'id=modal_<?php echo $page_dir; ?>_contents_<?php echo $page_name; ?>&path=/right_contents_box&page_name=<?php echo $page_dir; ?>&menu_name=<?php echo $page_name; ?>', true);">
                    ...
                    <div class="width_px_038 height_px_032 padding_px-x_009 padding_px-y_006 border_px-a_001 margin_px-r_005 pointer refresh_icon_2 filter_modal_open_button"
    ...
    l-35.213,17.453v-90.546c0-1.741-0.605-3.428-1.713-4.771L23.404,24.682h200.651L143.097,122.873z" />
                ...
                <div class="position1">
                    <input class="search_input" type="text" name="search_input" id="<?php echo $page_name; ?>_search_input">
...
<div class="padding_px-a_003 font_style_center">
    <select class="array_select" name="order" id="<?php echo $page_name; ?>_order_select">
...
<div class="padding_px-a_003 font_style_center">
    <select class="array_select" name="per_page" id="<?php echo $page_name; ?>_per_page_select">
...
document.getElementById('<?php echo $page_name; ?>_search_input_button').addEventListener('click', function () {
    ...
    const url = `id=modal_<?php echo $page_dir; ?>_contents_<?php echo $page_name; ?>&path=/right_contents_box&page_name=<?php echo $page_dir; ?>&menu_name=<?php echo $page_name; ?>&page=1&per_page=${currentPerPage}&order=${currentOrder}&search_input=${encodeURIComponent(searchInput)}`;
...
(() => {
    ...
    if (perPageSelect) {
        ...
        perPageSelect.addEventListener('change', function () {
            ...
            const url = `id=modal_<?php echo $page_dir; ?>_contents_<?php echo $page_name; ?>&path=/right_contents_box&page_name=<?php echo $page_dir; ?>&menu_name=<?php echo $page_name; ?>&page=${page}&per_page=${selectedValue}&order=${currentOrder}&search_input=${encodeURIComponent(searchValue)}`;
            egbInitializeMenu('<?php echo $page_dir; ?>');
            egbT('modal_<?php echo $page_dir; ?>_contents', url, true);
        });
    }
    ...
    if (orderSelect) {
        orderSelect.addEventListener('change', function () {
            ...
            const url = `id=modal_<?php echo $page_dir; ?>_contents_<?php echo $page_name; ?>&path=/right_contents_box&page_name=<?php echo $page_dir; ?>&menu_name=<?php echo $page_name; ?>&page=${currentPage}&per_page=${perPageValue}&order=${selectedValue}&search_input=${encodeURIComponent(searchValue)}`;
            egbInitializeMenu('<?php echo $page_dir; ?>');
            egbT('modal_<?php echo $page_dir; ?>_contents', url, true);
        });
    }
            ...
            <div class="flex_fl_yc change_button_filter_off">
                ...
                <div class="padding_px-y_005 padding_px-x_020 border_px-a_001 border_bre-a_005 margin_px-x_010 pointer display_off <?php echo $page_name; ?>_check_edit"
                ...
                <div class="padding_px-y_005 padding_px-x_020 border_px-a_001 border_bre-a_005 margin_px-x_010 pointer <?php echo $page_name; ?>_check_add <?php echo $add_button; ?>"
                    ...
                    data-hover-bg-color="#006b00" egb:click="egbToggle('add_<?php echo $page_name; ?>_box', 'display_off', 'z-index_7');
                    egbT('add_<?php echo $page_name; ?>_contents_box', 'id=<?php echo $page_name; ?>_add&path=/admin_main_contents/<?php echo $page_dir; ?>/menu_add/add_<?php echo $page_name; ?>&page_name=<?php echo $page_dir; ?>&menu_name=<?php echo $page_name; ?>', true);">추가</div>
            </div>
            <div class="flex_fl_yc font_px_015 change_button_filter_on display_off">
                ...
                <div class="padding_px-y_005 padding_px-x_020 border_px-a_001 border_bre-a_005 margin_px-x_010 pointer"
                    data-bd-a-color="#dddddd" data-bg-color="#ffa500aa" data-color="#ffffff"
                    data-hover-bg-color="#ffa500">바꿈</div>
                <div class="padding_px-y_005 padding_px-x_020 border_px-a_001 border_bre-a_005 margin_px-x_010 pointer"
                    data-bd-a-color="#dddddd" data-bg-color="#14870c" data-color="#ffffff"
...
<div class="<?php echo $page_name; ?>_box position1 <?php echo $page_dir; ?>_height max_width_9999 scrolls_1 point_all_reset overflow_x_hidden scrollbar"
    egb:mouseover="egbClassDel('<?php echo $page_dir; ?>_box_menu', 'menu_box'); egbClassDel('<?php echo $page_name; ?>_loading', 'egb_loading');"
    egb:mouseout="egbClassAdd('<?php echo $page_dir; ?>_box_menu', 'menu_box'); egbClassAdd('<?php echo $page_name; ?>_loading', 'egb_loading');">
    <div class="position1 max_width_9999 max_height_9999 font_px_014 scrollbar" data-top="0%" data-left="0%">
        <div class="position4 z-index_2 max_width_9999" data-top="0%" data-left="0%">
            <div class="flex_fl width_box">
                ...
                <div class="flex_xc_yc width_box min_width_100 max_width_100 padding_px-y_010 border_px-y_002 border_px-x_001"
                    data-bg-color="#e5e5e5" data-bd-a-color="#d9d9d9">상태</div>
                <div class="flex_xc_yc width_box min_width_100 max_width_100 padding_px-y_010 border_px-y_002 border_px-x_001"
                    data-bg-color="#e5e5e5" data-bd-a-color="#d9d9d9">순서</div>
                <div class="flex_xc_yc width_box min_width_200 max_width_200 padding_px-y_010 border_px-y_002 border_px-x_001"
                    data-bg-color="#e5e5e5" data-bd-a-color="#d9d9d9">페이지 제목</div>
                <div class="flex_xc_yc width_box min_width_200 max_width_200 padding_px-y_010 border_px-y_002 border_px-x_001"
                    data-bg-color="#e5e5e5" data-bd-a-color="#d9d9d9">페이지 이름</div>
                <div class="flex_xc_yc width_box padding_px-y_010 border_px-y_002 border_px-x_001"
                    data-bg-color="#e5e5e5" data-bd-a-color="#d9d9d9">페이지 경로</div>
            </div>
        </div>
        <?php
        // 결과 확인 및 반복 출력
                ...
                <label class="<?php echo $page_name; ?>_item" for="<?php echo $page_name; ?>_check_<?php echo $class_index; ?>"
                    ...
                    <div class="flex_fl width_box <?php echo $page_name; ?>_class_hover">
                        ...
                        <form id="<?php echo $page_name; ?>_status_form_input_<?php echo $class_index; ?>" 
                            action="<?php echo DOMAIN . '/?post=egb_game_banner_status_form_input'; ?>" 
                            method="post" enctype="multipart/form-data" 
                            class="flex_xc_yc min_width_100 max_width_100 padding_px-y_010 border_px-u_002 border_px-x_001"
                            data-bg-color="#f9f9f9" data-bd-a-color="#d9d9d9">
                            <input type="hidden" name="banner_uniq_id" value="<?php echo $row['uniq_id']; ?>">
                            <select class="select_submit" name="banner_status">
                                <option value="1" <?php echo ($row['is_status'] == 1) ? 'selected' : ''; ?>>활성화</option>
                                <option value="0" <?php echo ($row['is_status'] == 0) ? 'selected' : ''; ?>>비활성화</option>
                            </select>
                        </form>
                        <div class="flex_xc_yc min_width_100 max_width_100 padding_px-y_010 border_px-u_002 border_px-x_001"
                            data-bg-color="#f9f9f9" data-bd-a-color="#d9d9d9"><?php echo $row['display_order']; ?></div>
                        <div class="flex_xc_yc min_width_200 max_width_200 padding_px-y_010 border_px-u_002 border_px-x_001"
                            data-bg-color="#f9f9f9" data-bd-a-color="#d9d9d9"><?php echo $row['page_title']; ?></div>
                        <div class="flex_xc_yc min_width_200 max_width_200 padding_px-y_010 border_px-u_002 border_px-x_001"
                            data-bg-color="#f9f9f9" data-bd-a-color="#d9d9d9"><?php echo $row['page_name']; ?></div>
                        <div class="flex_xc_yc width_box padding_px-y_010 border_px-u_002 border_px-x_001"
                            data-bg-color="#f9f9f9" data-bd-a-color="#d9d9d9"><?php echo $row['page_path']; ?></div>
                    </div>
                </label>
                <?php
                $class_index++;
...
<script nonce="<?php echo NONCE; ?>">
//2024.12.25 선택시 본인만 선택되고 나머진 해제되도록 하는 로직
    (() => {
        // 부모 요소 선택
			...
			if (targetElement && targetElement.classList.contains('<?php echo $page_name; ?>_item')) {
				...
				if (checkbox) {
					...
					if (checkbox.checked) {
						...
						egbT('edit_<?php echo $page_name; ?>_contents_box', 'id=' + uniqId + '&path=/admin_main_contents/<?php echo $page_dir; ?>/menu_edit/edit_<?php echo $page_name; ?>&uniq_id=' + uniqId + '&page_name=<?php echo $page_dir ?>&menu_name=<?php echo $page_name; ?>', true);
						<?php endif; ?>
...
<div class="position4 z-index_5 flex_xs1_yc padding_px-x_020 width_box height_px_040 border_px-t_001 font_px_018 fontstyle2"
    ...
    <div class="width_px_020 height_px_020 pointer refresh_icon_2" title="인쇄">
    ...
    <div class="flex_xc_yc width_px_030 height_px_034 margin_px-x_002 border_px-a_001 pointer"
         ...
         <?php if ($page > 5): ?>
             egb:click="egbInitializeMenu('<?php echo $page_dir; ?>'); egbT('modal_<?php echo $page_dir; ?>_contents', 'id=modal_<?php echo $page_dir; ?>_contents_<?php echo $page_name; ?>&path=/right_contents_box&page_name=<?php echo $page_dir; ?>&menu_name=<?php echo $page_name; ?>&page=<?php echo max($page - 5, 1); ?>&per_page=<?php echo $perPage; ?>&order=<?php echo $order; ?>', true);"
         <?php else: ?>
    ...
    <div class="flex_xc_yc width_px_030 height_px_034 margin_px-x_002 border_px-a_001 pointer"
         data-bd-a-color="#d9d9d9" data-hover-bg-color="#dddddd"
         <?php if ($page > 1): ?>
             egb:click="egbInitializeMenu('<?php echo $page_dir; ?>'); egbT('modal_<?php echo $page_dir; ?>_contents', 'id=modal_<?php echo $page_dir; ?>_contents_<?php echo $page_name; ?>&path=/right_contents_box&page_name=<?php echo $page_dir; ?>&menu_name=<?php echo $page_name; ?>&page=<?php echo $page - 1; ?>&per_page=<?php echo $perPage; ?>&order=<?php echo $order; ?>', true);"
         <?php else: ?>
             style="pointer-events: none; opacity: 0.5;"
         <?php endif; ?>>
        <div class="flex_xc_yc width_px_017 height_px_017 rotate_icon">
    ...
    for ($i = $startPage; $i <= $endPage; $i++): ?>
        <div class="flex_xc_yc width_px_030 height_px_034 margin_px-x_002 border_px-a_001 pointer <?php echo ($i == $page) ? 'pagination_choice_color' : ''; ?>"
             data-bd-a-color="#d9d9d9" data-hover-bg-color="#dddddd"
             egb:click="egbInitializeMenu('<?php echo $page_dir; ?>'); egbT('modal_<?php echo $page_dir; ?>_contents', 'id=modal_<?php echo $page_dir; ?>_contents_<?php echo $page_name; ?>&path=/right_contents_box&page_name=<?php echo $page_dir; ?>&menu_name=<?php echo $page_name; ?>&page=<?php echo $i; ?>&per_page=<?php echo $perPage; ?>&order=<?php echo $order; ?>', true);">
            <?php echo $i; ?>
        </div>
    <?php endfor; ?>
    <div class="flex_xc_yc width_px_030 height_px_034 margin_px-x_002 border_px-a_001 pointer"
    ...
    <div class="flex_xc_yc width_px_030 height_px_034 margin_px-x_002 border_px-a_001 pointer"
         ...
         <?php if ($page <= $totalPages - 5): ?>
             egb:click="egbInitializeMenu('<?php echo $page_dir; ?>'); egbT('modal_<?php echo $page_dir; ?>_contents', 'id=modal_<?php echo $page_dir; ?>_contents_<?php echo $page_name; ?>&path=/right_contents_box&page_name=<?php echo $page_dir; ?>&menu_name=<?php echo $page_name; ?>&page=<?php echo min($page + 5, $totalPages); ?>&per_page=<?php echo $perPage; ?>&order=<?php echo $order; ?>', true);"
         <?php else: ?>
             style="pointer-events: none; opacity: 0.5;"
         <?php endif; ?>>
        <div class="flex_xc_yc width_px_017 height_px_017">
...
<div class="position2 width_px_300 height_box overflow_y_auto z-index_4 scrollbar filter_modal display_off"
    ...
    <div class="height_box height_auto padding_px-t_080 padding_px-u_040 font_px_012">
        <div class="padding_px-a_010">
            <div class="">
                <div class="padding_px-u_003">상태</div>
                <select class="width_box padding_px-x_010 padding_px-y_006" name="" id="">
            ...
            <div class="padding_px-u_005">
                <div class="padding_px-u_003">아이디</div>
                <input class="width_box padding_px-x_010 padding_px-y_006 font_px_012 folders_input_design" type="text" name="" id="">
            </div>
            <div class="padding_px-u_005">
                <div class="padding_px-u_003">닉네임</div>
                <input class="width_box padding_px-x_010 padding_px-y_006 font_px_012 folders_input_design" type="text" name="" id="">
            </div>
            <div class="padding_px-u_005">
                <div class="padding_px-u_003">전화번호</div>
                <input class="width_box padding_px-x_010 padding_px-y_006 font_px_012 folders_input_design" type="text" name="" id="">
            </div>
            <div class="padding_px-u_005">
                <div class="padding_px-u_003">이메일</div>
                <input class="width_box padding_px-x_010 padding_px-y_006 font_px_012 folders_input_design" type="text" name="" id="">
            </div>
            <div class="padding_px-u_005">
                <div class="padding_px-u_003">성별</div>
                <div class="flex_fl_yc width_box padding_px-x_010 padding_px-y_009 border_bre-a_005 input_gender_box_design"
                    data-bg-color="#ffffff">
                    <div class="flex_fl_yc padding_px-r_015">
                        <label class="padding_px-r_003" for="<?php echo $page_name; ?>_filter_select_gender_all">전체</label>
                        <input id="<?php echo $page_name; ?>_filter_select_gender_all" name="filter_select_gender"
                            class="width_px_014 height_px_014 border_px-a_001 border_bre-a_100 filter_select_gender_radio"
                            data-bg-color="#ffffff" data-bd-a-color="#d1d1d1" type="radio" name="" id="">
                    </div>
                    <div class="flex_fl_yc padding_px-r_015">
                        <label class="padding_px-r_003" for="<?php echo $page_name; ?>_filter_select_gender_male">남자</label>
                        <input id="<?php echo $page_name; ?>_filter_select_gender_male" name="filter_select_gender"
                            class="width_px_014 height_px_014 border_px-a_001 border_bre-a_100 filter_select_gender_radio"
                            data-bg-color="#ffffff" data-bd-a-color="#d1d1d1" type="radio" name="" id="">
                    </div>
                    <div class="flex_fl_yc padding_px-r_015">
                        <label class="padding_px-r_003" for="<?php echo $page_name; ?>_filter_select_gender_female">여자</label>
                        <input id="<?php echo $page_name; ?>_filter_select_gender_female" name="filter_select_gender"
                            class="width_px_014 height_px_014 border_px-a_001 border_bre-a_100 filter_select_gender_radio"
                            data-bg-color="#ffffff" data-bd-a-color="#d1d1d1" type="radio" name="" id="">
                    </div>
                </div>
            ...
            <div class="padding_px-u_005">
                <div class="padding_px-u_003">나이</div>
                <div class="flex_xs1_yc">
                    <input class="width_box padding_px-x_010 padding_px-y_006 font_px_012 folders_input_design number_input_design"
                        type="number">
                    <div class="padding_px-x_003">-</div>
                    <input class="width_box padding_px-x_010 padding_px-y_006 font_px_012 folders_input_design number_input_design"
                        type="number">
                </div>
            </div>
            <div class="padding_px-u_005">
                <div class="padding_px-u_003">레벨</div>
                <div class="flex_xs1_yc">
                    <input class="width_box padding_px-x_010 padding_px-y_006 font_px_012 folders_input_design number_input_design"
                        type="number">
                    <div class="padding_px-x_003">-</div>
            ...
            <div class="padding_px-u_005">
                <div class="padding_px-u_003">포인트</div>
                <div class="flex_xs1_yc">
                    <input class="width_box padding_px-x_010 padding_px-y_006 font_px_012 folders_input_design number_input_design"
                        type="number">
                    <div class="padding_px-x_003">-</div>
            ...
            <div class="padding_px-u_005">
                <div class="padding_px-u_003">가입기간</div>
                <div class="flex_xs1_yc">
                    <input class="width_box padding_px-x_010 padding_px-y_006 font_px_012 folders_input_design" type="date">
                    <div class="padding_px-x_003">-</div>
                    <input class="width_box padding_px-x_010 padding_px-y_006 font_px_012 folders_input_design" type="date">
                </div>
            </div>
...
<script nonce="<?php echo NONCE; ?>">
    (() => {
        document.querySelectorAll('.filter_modal_open_button').forEach((filterButton) => {
            filterButton.addEventListener('click', function () {
                const modalFolder = document.getElementById('modal_<?php echo $page_dir; ?>_contents');
                const filterModal = document.querySelectorAll('.filter_modal');
                const changeButtonOn = document.querySelectorAll('.change_button_filter_on');
                const changeButtonOff = document.querySelectorAll('.change_button_filter_off');
        ...
        function handleOutsideClick(event) {
            const filterModals = document.querySelectorAll('.filter_modal');
            const filterButtons = document.querySelectorAll('.filter_modal_open_button');
            const changeButtonsOn = document.querySelectorAll('.change_button_filter_on');
            ...
            filterModals.forEach((modal, index) => {
                ...
                if (
                    ...
                    closeModal(modal, changeButtonOn, document.querySelectorAll('.change_button_filter_off')[index]);
                }
            });
        }
    })();
